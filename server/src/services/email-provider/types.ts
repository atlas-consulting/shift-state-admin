...
export type AuthClientCredentials =
  | GoogleAuthClientCreds
  | MicrosoftAuthClientCreds;

/**
 *
 */
export type EmailProviderAuthConfig = Record<
  EmailProvider,
...
export type EmailProviderAuthRequest =
  | AuthURLRequest<EmailProviderTypes>
  | AuthTokenRequest<EmailProviderTypes>;
